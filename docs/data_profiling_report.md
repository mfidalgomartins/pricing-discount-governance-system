...
- Best metrics for analysis: total_orders, total_order_items, total_revenue, avg_discount_pct, weighted_discount_pct, share_order_items_discounted, product_diversity, avg_margin_proxy_pct, realized_price_cv, share_orders_discounted
