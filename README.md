...
- Release gate: `scripts/release_gate.py` enforces policy in `configs/release_policy.json` before publish
- Metric contracts: `configs/metric_contracts.json` defines governed KPI/table constraints
